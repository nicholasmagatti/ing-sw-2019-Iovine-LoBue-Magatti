...
public class SetupGameState extends Observable<SetupMessage> implements IState {
    @Override
    public void menu(StateContext stateContext) {
        ...
        //TODO: cambiare il messaggio in modo che contenta i due dati appena inseriti
